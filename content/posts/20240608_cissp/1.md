...
tags: ["セキュリティ", "資格"]
keywords: ["セキュリティ", "資格"]
description: "CISSP試験で出題されるセキュリティガバナンスの主要フレームワーク（NIST、ITIL、ISO27000、COSO、COBIT）の特徴と違いを比較します。"
---
...
- [セキュリティ資格比較：CISSP vs 情報処理安全確保支援士]({{< ref "/posts/20260223_security_certs/1.md" >}}) - CISSPと日本の情報処理安全確保支援士（登録セキスペ）を、受験要件・費用・難易度・キャリアへの効果の観点から徹底比較しています。
