...
draft: false
description: "Wavelet transform tutorial: CWT and DWT mathematical foundations, time-frequency analysis vs FFT, and Python implementations using PyWavelets for signal decomposition and denoising."
...
- [Window Functions and Power Spectral Density (PSD): Theory and Python Implementation]({{< ref "/posts/20260228_fft_window_psd/1.en.md" >}}) - FFT window functions and PSD estimation in detail.
...
- [Time-Series Anomaly Detection: From Statistical Methods to Kalman Filter in Python]({{< ref "/posts/20260228_timeseries_anomaly/1.en.md" >}}) - Anomaly detection methods where wavelet transform can serve as preprocessing.
- [Wiener Filter: Optimal Linear Filtering Theory and Python Implementation]({{< ref "/posts/20260226_wiener_filter/1.en.md" >}}) - A different approach to optimal noise removal.
...
- [Moving Average Filters Compared: SMA, WMA, and EMA in Python]({{< ref "/posts/20260225_moving_average/1.en.md" >}}) - Helps understand the relationship between time-domain filters and wavelet filter banks.
- [Matplotlib Practical Tips: Creating Publication-Quality Figures]({{< ref "/posts/20260223_matplotlib_tips/1.en.md" >}}) - Tips for producing higher-quality scalogram visualizations.
