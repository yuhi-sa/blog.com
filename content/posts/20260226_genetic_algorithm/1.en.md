...
draft: false
description: "How Genetic Algorithms work: selection, crossover, and mutation operators explained with a Python implementation for continuous optimization on the Rastrigin function benchmark."
...
- [Simulated Annealing: Theory and Python Implementation]({{< ref "/posts/20260226_simulated_annealing/1.en.md" >}}) - Another metaheuristic based on temperature-driven stochastic search.
...
- [From SGD to Adam: Evolution of Gradient-Based Optimization]({{< ref "/posts/20260226_sgd_adam/1.en.md" >}}) - Gradient-based optimization; GA is an alternative when gradients are unavailable.
- [MPPI (Model Predictive Path Integral): A Unified View with the Cross-Entropy Method]({{< ref "/posts/20260215_MPPI/1.en.md" >}}) - Sampling-based control optimization.
