...
1.  Slackの「設定と管理」から「アプリを管理する」を選択します。
    ![fig1.png](/posts/20201223_slack_api/fig1.png)

2.  Appディレクトリで「Incoming Webhooks」を検索し、Slackに追加します。
    ![fig2.png](/posts/20201223_slack_api/fig2.png)
    ![fig3.png](/posts/20201223_slack_api/fig3.png)

3.  「Slackに追加」ボタンを押した後、メッセージを投稿したいチャンネルを選択し、「Incoming Webhookインテグレーションの追加」をクリックします。
    ![fig4.png](/posts/20201223_slack_api/fig4.png)

4.  生成された「Webhook URL」をコピーします。**このURLは外部に漏れないように注意して扱ってください。**
    ![fig5.png](/posts/20201223_slack_api/fig5.png)

5.  設定ページでは、通知時のアイコンやボットの名前をカスタマイズすることも可能です。
    ![fig6.png](/posts/20201223_slack_api/fig6.png)
...
![fig7.png](/posts/20201223_slack_api/fig7.png)
...
![fig8.png](/posts/20201223_slack_api/fig8.png)
![fig9.png](/posts/20201223_slack_api/fig9.png)
