...
- [Creating 3D Animations (GIFs) with Python Matplotlib]({{< ref "/posts/20210630_py_plot/1.en.md" >}}) - Learn how to create graphs with Matplotlib that you can send to Slack as experiment results.
- [Matplotlib Practical Tips: Creating Publication-Quality Figures]({{< ref "/posts/20260223_matplotlib_tips/1.en.md" >}}) - Improve the quality of experiment result graphs sent to Slack.
- [GitHub Actions Basics]({{< ref "/posts/20210630_gtihub_action/1.en.md" >}}) - Useful reference for sending Slack notifications from CI/CD pipelines.
- [Introduction to Python Async: asyncio Basics and Practice]({{< ref "/posts/20260226_python_asyncio/1.en.md" >}}) - Async processing fundamentals for efficiently sending bulk notifications.
