...
keywords: ["Hugo", "TypeScript", "React", "Web開発"]
description: "HugoテーマにTypeScriptとReactを統合する方法を解説。Webpack設定、tsconfig.json、Reactコンポーネントのマウントまでの手順を紹介します。"
---
...
path: path.resolve(\_\_dirname, 'assets/js'), // 出力ディレクトリ
},
};
