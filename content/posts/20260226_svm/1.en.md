...
draft: false
description: "SVM explained: margin maximization theory, kernel trick (RBF, polynomial), soft margin with C parameter, scikit-learn implementation, and hyperparameter tuning with GridSearchCV."
...
- [Ensemble Learning: From Decision Trees to Random Forest and Gradient Boosting]({{< ref "/posts/20260226_ensemble_learning/1.en.md" >}}) - Alternative classification methods including Random Forest and GBDT.
- [Understanding Self-Attention from Scratch: Math and Python Implementation]({{< ref "/posts/20260228_self_attention/1.en.md" >}}) - Similarity between kernel tricks and Attention.
- [k-means and GMM: Clustering Theory and Python Implementation]({{< ref "/posts/20260226_kmeans_gmm/1.en.md" >}}) - Contrast supervised classification with unsupervised structure discovery.
...
- [Bayesian Linear Regression: From Least Squares to Bayesian Estimation]({{< ref "/posts/20210108_bayes/1.en.md" >}}) - Useful comparison between Bayesian regression and SVR.
