...
draft: false
description: "How to set up a local dev environment with Docker Compose: MySQL, Redis, and MinIO (S3-compatible) configuration, docker-compose.yml syntax, volume persistence, health checks, and networking."
