---
title: "How to Build an AirPlay Receiver on Raspberry Pi Using RPiPlay"
date: 2021-08-05T10:11:23+09:00
draft: false
images: ["https://yuhi-sa.github.io/ogp.jpeg"]
tags: ["Raspberry Pi", "AirPlay", "Linux"]
description: "Step-by-step guide to installing RPiPlay on Raspberry Pi to create an AirPlay receiver, including systemd auto-start configuration."
---
...
- [Syncing Google Calendar Sub-calendars on Apple Devices]({{< ref "/posts/20210912_google_cal_sync/1.en.md" >}}) - Integrating Apple products with Google services.
- [GitHub Actions Basics]({{< ref "/posts/20210630_gtihub_action/1.en.md" >}}) - Automate RPiPlay builds and CI/CD pipeline setup.
- [Docker Compose: Building and Managing Multi-Container Environments]({{< ref "/posts/20260226_docker_compose/1.en.md" >}}) - Docker-based service management applicable to Raspberry Pi.
