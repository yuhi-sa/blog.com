...
description: "Raspberry PiにRPiPlayをインストールしてAirPlayレシーバーを構築する手順と、systemdで自動起動する設定方法を解説します。"
tags: ["Raspberry Pi", "AirPlay", "Linux"]
keywords: ["Raspberry Pi", "AirPlay", "Linux"]
---
...
- [AppleデバイスでGoogleカレンダーのサブカレンダー同期設定]({{< ref "/posts/20210912_google_cal_sync/1.md" >}}) - Apple製品とGoogleサービスの連携に関する記事です。
- [GitHub Actionsの基本的な書き方]({{< ref "/posts/20210630_gtihub_action/1.md" >}}) - RPiPlayのビルド自動化やCI/CDパイプラインの構築に応用できます。
- [Docker Composeによるマルチコンテナ環境の構築と管理]({{< ref "/posts/20260226_docker_compose/1.md" >}}) - Raspberry Pi上でDockerを使ったサービス管理に応用できます。
