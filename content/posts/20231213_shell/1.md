...
keywords: ["シェルスクリプト", "Excel", "CSV"]
description: "xlsx2csvとシェルスクリプトを使い、ディレクトリ内のExcelファイル（.xlsx）を一括でCSVに変換する方法を解説。スクリプトの各部分も詳しく説明します。"
---
...
- [Chmod計算機（DevToolBox）](https://yuhi-sa.github.io/devtoolbox/tools/chmod-calculator/) - ファイルパーミッションの数値・記号表記を変換
