...
draft: false
description: "Python asyncio tutorial: how async/await works, event loop internals, concurrent task execution with gather and TaskGroup, and practical async HTTP request examples with aiohttp."
...
- [Python Decorators: Mechanics and Practical Patterns]({{< ref "/posts/20260226_python_decorators/1.en.md" >}}) - Decorator patterns useful for implementing async decorators.
- [Python Regular Expressions: Practical Guide]({{< ref "/posts/20260226_python_regex/1.en.md" >}}) - Regex patterns for async text processing.
- [Building a Progress Bar in Python from Scratch]({{< ref "/posts/20260223_progress_bar/1.en.md" >}}) - Progress bars applicable to async processing.
- [Matplotlib Practical Tips: Creating Publication-Quality Figures]({{< ref "/posts/20260223_matplotlib_tips/1.en.md" >}}) - Visualizing data retrieved via async processing.
...
- [How to Send Experiment Results to Slack with Python]({{< ref "/posts/20201223_slack_api/1.en.md" >}}) - Calling external APIs from Python, which can be made more efficient with async.
