...
draft: false
description: "Unscented Kalman Filter (UKF) explained: sigma point generation via Unscented Transform, UKF vs EKF comparison, and a step-by-step Python implementation for nonlinear state tracking."
...
- [Kalman Filter: Theory and Python Implementation]({{< ref "/posts/20260224_kalman_filter/1.en.md" >}}) - The linear Kalman filter that UKF extends.
- [Extended Kalman Filter (EKF): Theory and Python Implementation]({{< ref "/posts/20260224_ekf/1.en.md" >}}) - EKF's linearization approach that UKF improves upon.
- [Cubature Kalman Filter (CKF): Theory and Python Implementation]({{< ref "/posts/20260215_CKF/1.en.md" >}}) - Cubature Kalman filter that resolves UKF's weight issues.
- [Particle Filter Python Implementation: Comparing Resampling Methods]({{< ref "/posts/20260223_particle_filter/1.en.md" >}}) - For higher nonlinearity, particle filters are more suitable.
- [Kalman Smoother (RTS Smoother): Theory and Python Implementation]({{< ref "/posts/20260223_rts_smoother/1.en.md" >}}) - Foundation for UKF-based smoothers.
- [Unscented Transformation: Algorithm and Python Implementation]({{< ref "/posts/20210125_UT/1.en.md" >}}) - Detailed explanation of the core Unscented Transform.
- [Wiener Filter: Optimal Linear Filtering Theory and Python Implementation]({{< ref "/posts/20260226_wiener_filter/1.en.md" >}}) - Optimal linear filter for stationary processes; contrasts with UKF's role.
