...
draft: false
description: "RSA encryption explained: mathematical foundations (integer factorization, Euler's theorem), key generation algorithm, encryption and decryption steps, and a from-scratch Python implementation."
...
- [OAuth 2.0 and OpenID Connect: Fundamentals of Authorization and Authentication]({{< ref "/posts/20260226_oauth2_oidc/1.en.md" >}}) - RSA is used in JWT signature verification for OAuth 2.0/OIDC.
- [Zero Trust Architecture: Principles, Components, and Implementation]({{< ref "/posts/20260226_zero_trust/1.en.md" >}}) - RSA serves as a foundational cryptographic technology in Zero Trust.
- [Security Certification Comparison: CISSP vs Japan's Registered Information Security Specialist]({{< ref "/posts/20260223_security_certs/1.en.md" >}}) - Compares security certifications whose exam scope includes cryptographic technologies.
...
- [Fast Modular Exponentiation Using Binary Exponentiation in Python]({{< ref "/posts/20201220_Binary/1.en.md" >}}) - Explains the exponentiation by squaring algorithm used in RSA encryption and decryption.
