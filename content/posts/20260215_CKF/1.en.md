...
draft: false
description: "What is the Cubature Kalman Filter? Learn CKF theory with spherical-radial cubature rule derivation, comparison to UKF, and step-by-step Python implementation for nonlinear state estimation."
...
- [Kalman Filter: Theory and Python Implementation]({{< ref "/posts/20260224_kalman_filter/1.en.md" >}}) - The linear Kalman filter that forms the foundation of CKF.
- [Extended Kalman Filter (EKF): Theory and Python Implementation]({{< ref "/posts/20260224_ekf/1.en.md" >}}) - Jacobian-based linearization approach for nonlinear systems.
- [Unscented Kalman Filter (UKF): Nonlinear State Estimation Theory and Python Implementation]({{< ref "/posts/20260226_ukf/1.en.md" >}}) - A sigma-point method in the same family as CKF.
...
- [Kalman Smoother (RTS Smoother): Theory and Python Implementation]({{< ref "/posts/20260223_rts_smoother/1.en.md" >}}) - Smoothing filter results using observations from all time steps.
