...
![Least squares regression result showing overfitting](/posts/20210108_bayes/fig1.png)

#### MAP Estimation

The prior distribution (regularization) suppresses overfitting, yielding a smoother prediction curve.
![MAP estimation regression result with regularization](/posts/20210108_bayes/fig2.png)
...
![Bayesian estimation regression result with confidence interval](/posts/20210108_bayes/fig3.png)
...
![Comparison of R-squared values across estimation methods](/posts/20210108_bayes/fig4.png)
...
- $\beta=50$
  ![Bayesian estimation result with beta=50](/posts/20210108_bayes/fig5.png)
- $\beta=100$
  ![Bayesian estimation result with beta=100](/posts/20210108_bayes/fig6.png)
- $\beta=1000$
  ![Bayesian estimation result with beta=1000](/posts/20210108_bayes/fig7.png)
...
- C.M. Bishop, [Pattern Recognition and Machine Learning](https://www.amazon.co.jp/dp/0387310738?tag=tomatomato119-22), Springer (2006)
- Atsushi Suyama, [Introduction to Machine Learning with Bayesian Inference](https://www.amazon.co.jp/dp/4061538322?tag=tomatomato119-22), Kodansha (2017)
