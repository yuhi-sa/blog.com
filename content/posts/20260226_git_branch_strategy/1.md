...
draft: false
description: "Git Flow・GitHub Flow・トランクベース開発の3つのブランチ戦略を比較し、rebaseとmergeの使い分け、チーム規模に応じた選定基準をわかりやすく解説します。"
tags: ["Git", "DevOps"]
keywords:
  [
    "Git",
...
- [ゼロトラストセキュリティの概要と導入]({{< ref "/posts/20260226_zero_trust/1.md" >}}) - セキュリティ要件を考慮したブランチ保護ポリシーの参考になります。
...
- [DevToolBox .gitignore生成](https://yuhi-sa.github.io/devtoolbox/tools/gitignore/) - プロジェクトの言語・フレームワークに合わせた.gitignoreファイルをブラウザ上で自動生成できます。
