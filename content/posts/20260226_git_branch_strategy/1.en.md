...
draft: false
description: "Git Flow vs GitHub Flow vs trunk-based development compared: when to use each strategy, rebase vs merge trade-offs, and practical branching guidelines for team workflows."
tags: ["Git", "DevOps"]
keywords:
  [
    "Git branch strategy",
...
- [Local Development with Docker Compose: MySQL, Redis, and MinIO]({{< ref "/posts/20260226_docker_compose/1.en.md" >}}) - Combine development environment setup with branching strategy.
- [OAuth 2.0 and OpenID Connect: Fundamentals of Authorization and Authentication]({{< ref "/posts/20260226_oauth2_oidc/1.en.md" >}}) - Example of a feature developed on a feature branch.
- [Zero Trust Architecture: Principles, Components, and Implementation]({{< ref "/posts/20260226_zero_trust/1.en.md" >}}) - Security considerations for branch protection policies.
