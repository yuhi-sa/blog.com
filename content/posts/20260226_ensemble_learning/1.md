...
draft: false
description: "アンサンブル学習とは？決定木の基礎からランダムフォレスト（バギング）、GBDT・XGBoost・LightGBM（ブースティング）の仕組み、scikit-learnでのPython実装を解説します。"
...
- [Self-Attentionの仕組みとPython実装]({{< ref "/posts/20260228_self_attention/1.md" >}}) - Transformerベースの手法とアンサンブル学習の比較に有用です。
