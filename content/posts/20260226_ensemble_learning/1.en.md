...
draft: false
description: "Ensemble learning explained: from decision tree basics to Random Forest (bagging) and Gradient Boosting (GBDT, XGBoost, LightGBM), with theory comparison and scikit-learn Python implementation."
...
- [Understanding Self-Attention from Scratch: Math and Python Implementation]({{< ref "/posts/20260228_self_attention/1.en.md" >}}) - Transformer-based approaches for comparison with ensemble methods.
- [Support Vector Machines (SVM): Kernel Methods and Nonlinear Classification with Python]({{< ref "/posts/20260226_svm/1.en.md" >}}) - Comparison with another powerful classification method.
- [k-means and GMM: Clustering Theory and Python Implementation]({{< ref "/posts/20260226_kmeans_gmm/1.en.md" >}}) - Contrast with unsupervised learning; decision trees also compute feature importance.
- [From SGD to Adam: Evolution of Gradient-Based Optimization]({{< ref "/posts/20260226_sgd_adam/1.en.md" >}}) - Connection between gradient boosting's "gradient" and optimization methods.
