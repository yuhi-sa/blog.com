...
draft: false
description: "OAuth 2.0 vs OpenID Connect explained: authorization code flow, implicit flow, access tokens vs ID tokens, PKCE, and security best practices with sequence diagrams."
...
- [Zero Trust Architecture: Principles, Components, and Implementation]({{< ref "/posts/20260226_zero_trust/1.en.md" >}}) - How OAuth 2.0/OIDC serves as the authentication foundation for Zero Trust.
- [RSA Encryption: Theory and Python Implementation]({{< ref "/posts/20260225_rsa/1.en.md" >}}) - Mathematical foundations of RSA used in JWT signature verification.
- [Security Certification Comparison: CISSP vs Japan's Registered Information Security Specialist]({{< ref "/posts/20260223_security_certs/1.en.md" >}}) - Overview of security certifications.
- [CISSP: Comparing Major Security Governance Frameworks]({{< ref "/posts/20240608_cissp/1.en.md" >}}) - Overview of security frameworks.
...
- [Email Security: Authentication and Encryption Technologies]({{< ref "/posts/20230328_mail_auth/1.en.md" >}}) - Authentication technologies for email.
