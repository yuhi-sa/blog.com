...
draft: false
description: "SGD・Momentum・RMSProp・Adamの違いとは？深層学習で使われる勾配ベース最適化アルゴリズムの数理と特性を比較し、PyTorchでの実装と収束挙動の可視化を紹介します。"
...
- [焼きなまし法（Simulated Annealing）の理論とPython実装]({{< ref "/posts/20260226_simulated_annealing/1.md" >}}) - 勾配を使わないメタヒューリスティクスとの比較が有益です。
- [遺伝的アルゴリズム（GA）の理論とPython実装]({{< ref "/posts/20260226_genetic_algorithm/1.md" >}}) - 勾配を使わない進化的最適化手法を解説しています。
