...
draft: false
description: "SGD vs Adam optimizer comparison: mathematical formulations of SGD, Momentum, RMSProp, and Adam with convergence visualization and PyTorch implementation for deep learning training."
...
- [Simulated Annealing: Theory and Python Implementation]({{< ref "/posts/20260226_simulated_annealing/1.en.md" >}}) - Gradient-free metaheuristic for comparison.
- [Genetic Algorithms: Fundamentals and Python Implementation]({{< ref "/posts/20260226_genetic_algorithm/1.en.md" >}}) - Gradient-free evolutionary optimization.
...
- [Understanding Self-Attention from Scratch: Math and Python Implementation]({{< ref "/posts/20260228_self_attention/1.en.md" >}}) - Transformers where Adam is the standard optimizer.
...
- [Bayesian Linear Regression: From Least Squares to Bayesian Estimation]({{< ref "/posts/20210108_bayes/1.en.md" >}}) - Bayesian parameter estimation without gradient descent.
