...
- [焼きなまし法（Simulated Annealing）の理論とPython実装]({{< ref "/posts/20260226_simulated_annealing/1.md" >}}) - MPPIと同じく確率的探索に基づく最適化手法を解説しています。
- [ベイズ最適化の基礎とPython実装]({{< ref "/posts/20260223_bayesian_optimization/1.md" >}}) - 代理モデルベースの効率的な最適化手法を解説しています。
- [遺伝的アルゴリズム（GA）の理論とPython実装]({{< ref "/posts/20260226_genetic_algorithm/1.md" >}}) - 進化的計算に基づくメタヒューリスティクスを解説しています。
- [PID制御の実装とチューニング]({{< ref "/posts/20260225_pid_impl/1.md" >}}) - MPPIの比較対象となる古典的な制御手法を解説しています。
