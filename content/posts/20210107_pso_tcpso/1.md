...
draft: false
description: "粒子群最適化(PSO)と協調型二群PSO(TCPSO)のアルゴリズムを解説し、Matlabによる実装コードを紹介。局所解への対策も説明します。"
tags: ["群知能", "最適化", "Matlab"]
keywords: ["群知能", "最適化", "Matlab"]
---
...
![PSOにおける粒子の速度更新の概念図](/posts/20210107_pso_tcpso/fig1.png)
...
- $t=0$
  ![PSO探索結果 t=0（初期状態）](/posts/20210107_pso_tcpso/fig2.png)
- $t=250$
  ![PSO探索結果 t=250（収束途中）](/posts/20210107_pso_tcpso/fig3.png)
- $t=500$
  ![PSO探索結果 t=500（局所解に収束）](/posts/20210107_pso_tcpso/fig4.png)
...
- **スレーブ粒子群 (Slave Swarm)**
  ...
  ![スレーブ粒子群の速度更新の概念図](/posts/20210107_pso_tcpso/fig5.png)
...
- **マスター粒子群 (Master Swarm)**
  ...
  ![マスター粒子群の速度更新の概念図](/posts/20210107_pso_tcpso/fig6.png)
...
- $t=0$
  ![TCPSO探索結果 t=0（初期状態）](/posts/20210107_pso_tcpso/fig7.png)
- $t=250$
  ![TCPSO探索結果 t=250（スレーブ群が収束中）](/posts/20210107_pso_tcpso/fig8.png)
- $t=500$
  ![TCPSO探索結果 t=500（マスター群が多様性を維持）](/posts/20210107_pso_tcpso/fig9.png)
...
- [遺伝的アルゴリズムによるニューラルネットワーク学習のPython実装]({{< ref "/posts/20210109_nnga/1.md" >}}) - 同じ群知能カテゴリの進化的最適化手法
- [焼きなまし法（Simulated Annealing）の仕組みとPython実装]({{< ref "/posts/20260226_simulated_annealing/1.md" >}}) - メタヒューリスティクスによる別の最適化手法
- [クロスエントロピー法：モンテカルロ最適化の実践的手法]({{< ref "/posts/20210329_CEM/1.md" >}}) - 確率分布ベースの最適化アルゴリズム
