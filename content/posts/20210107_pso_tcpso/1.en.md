...
![Conceptual diagram of PSO particle velocity update](/posts/20210107_pso_tcpso/fig1.png)
...
- $t=0$
  ![PSO search result at t=0 (initial state)](/posts/20210107_pso_tcpso/fig2.png)
- $t=250$
  ![PSO search result at t=250 (converging)](/posts/20210107_pso_tcpso/fig3.png)
- $t=500$
  ![PSO search result at t=500 (converged to local optimum)](/posts/20210107_pso_tcpso/fig4.png)
...
- **Slave Swarm**
  ...
  ![Slave swarm velocity update diagram](/posts/20210107_pso_tcpso/fig5.png)
...
- **Master Swarm**
  ...
  ![Master swarm velocity update diagram](/posts/20210107_pso_tcpso/fig6.png)
...
- $t=0$
  ![TCPSO search result at t=0 (initial state)](/posts/20210107_pso_tcpso/fig7.png)
- $t=250$
  ![TCPSO search result at t=250 (slave swarm converging)](/posts/20210107_pso_tcpso/fig8.png)
- $t=500$
  ![TCPSO search result at t=500 (master swarm maintaining diversity)](/posts/20210107_pso_tcpso/fig9.png)
...
- [Training Neural Networks with Genetic Algorithms in Python]({{< ref "/posts/20210109_nnga/1.en.md" >}}) - An evolutionary optimization method from the same swarm intelligence category
- [Simulated Annealing: Theory and Python Implementation]({{< ref "/posts/20260226_simulated_annealing/1.en.md" >}}) - Another metaheuristic optimization approach
- [Cross-Entropy Method: A Practical Monte Carlo Optimization Technique]({{< ref "/posts/20210329_CEM/1.en.md" >}}) - A distribution-based optimization algorithm
