...
draft: false
description: "What is FFT? From the Discrete Fourier Transform (DFT) definition to the Cooley-Tukey FFT algorithm, with practical frequency analysis examples using NumPy and SciPy in Python."
...
- [Moving Average Filters Compared: SMA, WMA, and EMA in Python]({{< ref "/posts/20260225_moving_average/1.en.md" >}}) - Explains the differences in frequency characteristics of SMA, WMA, and EMA.
...
- [Matplotlib Practical Tips: Creating Publication-Quality Figures]({{< ref "/posts/20260223_matplotlib_tips/1.en.md" >}}) - Covers settings for producing higher-quality spectrum plots.
- [Window Functions and Power Spectral Density (PSD): Theory and Python Implementation]({{< ref "/posts/20260228_fft_window_psd/1.en.md" >}}) - Detailed window function comparison and Welch's PSD estimation method.
- [Notch Filter Design and Python Implementation]({{< ref "/posts/20260228_notch_filter/1.en.md" >}}) - Practical approach to removing specific frequency noise discovered via FFT.
