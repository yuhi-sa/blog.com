...
draft: false
description: "Simulated Annealing explained: temperature scheduling, Boltzmann transition probability, and Python implementations for continuous function optimization and the Traveling Salesman Problem (TSP)."
...
- [Genetic Algorithms: Fundamentals and Python Implementation]({{< ref "/posts/20260226_genetic_algorithm/1.en.md" >}}) - Another metaheuristic based on evolutionary computation.
...
- [Markov Chain Monte Carlo (MCMC): Metropolis-Hastings and Gibbs Sampling]({{< ref "/posts/20260226_mcmc/1.en.md" >}}) - MCMC sampling using the same Metropolis criterion as SA.
- [MPPI (Model Predictive Path Integral): A Unified View with the Cross-Entropy Method]({{< ref "/posts/20260215_MPPI/1.en.md" >}}) - Sampling-based optimal control.
