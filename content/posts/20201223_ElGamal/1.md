...
draft: false
description: "楕円曲線ElGamal暗号の鍵生成・暗号化・復号の原理を解説し、Pythonによる簡易実装を紹介。公開鍵暗号の基礎を学べます。"
...
- [繰り返し二乗法による高速べき乗剰余計算のPython実装]({{< ref "/posts/20201220_Binary/1.md" >}}) - ElGamal暗号のスカラ倍算を高速化するための繰り返し二乗法を解説しています。
- [Diffie-Hellman鍵交換プロトコル：理論とPython実装]({{< ref "/posts/20230907_DH/1.md" >}}) - ElGamal暗号と同じ離散対数問題を安全性の根拠とする鍵交換プロトコルを解説しています。
