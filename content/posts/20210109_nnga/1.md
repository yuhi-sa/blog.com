...
![学習結果](/posts/20210109_nnga/fig1.png)

## 関連記事

- [粒子群最適化(PSO)と協調型PSO(TCPSO)の解説とMatlab実装]({{< ref "/posts/20210107_pso_tcpso/1.md" >}}) - 同じ群知能アプローチによる最適化手法
- [ニューラルネットワークを用いた教師あり学習のpythonプログラム]({{< ref "/posts/20210215_NN/1.md" >}}) - 勾配法（誤差逆伝播）によるNN学習との比較
- [クロスエントロピー法：モンテカルロ最適化の実践的手法]({{< ref "/posts/20210329_CEM/1.md" >}}) - 確率的な最適化手法の別アプローチ
