...
- [Particle Swarm Optimization (PSO) and Two-Swarm Cooperative PSO (TCPSO) with Matlab]({{< ref "/posts/20210107_pso_tcpso/1.en.md" >}}) - Another swarm intelligence optimization approach
- [Supervised Learning with Neural Networks in PyTorch]({{< ref "/posts/20210215_NN/1.en.md" >}}) - Comparison with gradient-based (backpropagation) NN training
- [Cross-Entropy Method: A Practical Monte Carlo Optimization Technique]({{< ref "/posts/20210329_CEM/1.en.md" >}}) - An alternative stochastic optimization approach
