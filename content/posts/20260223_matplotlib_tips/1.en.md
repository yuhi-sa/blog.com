...
draft: false
description: "How to create publication-quality figures with Matplotlib: rcParams configuration, font setup, colormap selection, subplot layout, and vector output (PDF/SVG) best practices."
...
![Complete example: publication-quality figure](/posts/20260223_matplotlib_tips/complete_example.png)
...
For an introduction to Matplotlib basics and creating 3D animations (GIF), see also [Creating 3D Animations with Matplotlib]({{< ref "/posts/20210630_py_plot/1.en.md" >}}).

## Related Articles

- [Fast Fourier Transform (FFT): Theory and Python Implementation]({{< ref "/posts/20260225_fft/1.en.md" >}}) - Contains spectrum graph visualization examples.
- [Moving Average Filters Compared: SMA, WMA, and EMA in Python]({{< ref "/posts/20260225_moving_average/1.en.md" >}}) - Contains filter comparison graph examples.
- [Building a Progress Bar in Python from Scratch]({{< ref "/posts/20260223_progress_bar/1.en.md" >}}) - Practical Python tips.
- [Python Decorators: Mechanics and Practical Patterns]({{< ref "/posts/20260226_python_decorators/1.en.md" >}}) - Practical Python tips on decorator patterns.
