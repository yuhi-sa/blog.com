...
draft: false
description: "ARIMAモデルとは？AR・MA・ARIMAの数学的定義からACF/PACFによるパラメータ選択、statsmodelsでのPython実装、季節性を扱うSARIMAモデルまでを体系的に解説します。"
...
- [時系列データの異常検知：統計的手法からカルマンフィルタまで]({{< ref "/posts/20260228_timeseries_anomaly/1.md" >}}) - ARIMAによる予測値からの逸脱を異常検知に利用する手法を解説しています。
- [移動平均フィルタの種類と比較]({{< ref "/posts/20260225_moving_average/1.md" >}}) - 移動平均フィルタの種類を解説しており、MAモデルの直感的な理解に役立ちます。
- [カルマンフィルタの理論とPython実装]({{< ref "/posts/20260224_kalman_filter/1.md" >}}) - 状態空間モデルに基づく時系列推定手法であり、ARIMAとの比較が有益です。
