...
draft: false
description: "ARIMA tutorial: AR, MA, and ARIMA model theory explained, parameter selection with ACF/PACF, Python implementation using statsmodels, and SARIMA extension for seasonal time series forecasting."
...
- [Time-Series Anomaly Detection: From Statistical Methods to Kalman Filter in Python]({{< ref "/posts/20260228_timeseries_anomaly/1.en.md" >}}) - Using ARIMA prediction deviations for anomaly detection.
- [Moving Average Filters Compared: SMA, WMA, and EMA in Python]({{< ref "/posts/20260225_moving_average/1.en.md" >}}) - Provides intuitive understanding of MA models.
- [Kalman Filter: Theory and Python Implementation]({{< ref "/posts/20260224_kalman_filter/1.en.md" >}}) - State-space model-based time series estimation; useful comparison with ARIMA.
- [Matplotlib Practical Tips: Creating Publication-Quality Figures]({{< ref "/posts/20260223_matplotlib_tips/1.en.md" >}}) - Tips for high-quality time series visualization.
...
- [Bayesian Linear Regression: From Least Squares to Bayesian Estimation]({{< ref "/posts/20210108_bayes/1.en.md" >}}) - Bayesian approaches to time series regression.
