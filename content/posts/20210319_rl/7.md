...
draft: false
description: "深層強化学習の主要アルゴリズムを網羅的に解説。A3C、DDPG、TRPO、PPOなどActor-Critic系・方策勾配系の手法の仕組みと特徴を紹介します。"
tags: ["強化学習", "深層学習"]
keywords: ["強化学習", "深層学習"]
---
...
![DNNを利用した強化学習手法](/posts/20210319_rl/DNN.png)
...
- **目的関数**: この制約の下で、アドバンテージ関数 $A_t$ を用いた目的関数を最大化します。
  ...
  ここで $\frac{\pi*\theta(a*t|s_t)}{\pi*{\theta\_{old}}(a_t|s_t)}$ は**確率比**と呼ばれ、更新前後の行動選択確率の比を表します。
...
- 久保隆宏, [Pythonで学ぶ強化学習 入門から実践まで](https://www.amazon.co.jp/dp/4065142989?tag=tomatomato119-22), 翔泳社 (2019)
