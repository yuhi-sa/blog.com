...
1.  **Sum of Future Rewards**: The sum of immediate rewards $G_t$ obtained from time $t$ onward can be defined recursively as follows:
    ...
    Here, $r*{t+1}$ is the immediate reward obtained at time $t+1$, and $\gamma$ is the **discount factor** ($0 \le \gamma \le 1$), a coefficient for converting future rewards to present value.
