...
draft: false
description: "Kalman Filter explained from scratch: state-space model, prediction and update step derivations with mathematical proofs, and a Python implementation with a 1D constant-velocity tracking example."
...
- Unscented Kalman Filter (UKF) based on the [Unscented Transform]({{< ref "/posts/20210125_UT/1.en.md" >}})
- [Cubature Kalman Filter (CKF)]({{< ref "/posts/20260215_CKF/1.en.md" >}})
- [Particle Filter]({{< ref "/posts/20260223_particle_filter/1.en.md" >}})

An overview of these methods is available in [Basics of Filtering Methods]({{< ref "/posts/20200901_Filter/1.en.md" >}}). This article explains the theory and implementation of the most fundamental Kalman Filter.
...
- [Fundamentals of Filtering Methods in Signal Processing]({{< ref "/posts/20200901_Filter/1.en.md" >}}) - Overview of Kalman Filter, EKF, UKF, and Particle Filter.
- [Unscented Transformation: Algorithm and Python Implementation]({{< ref "/posts/20210125_UT/1.en.md" >}}) - Sigma-point approach to handle nonlinear transformations without linearization.
...
- [Particle Filter Python Implementation: Comparing Resampling Methods]({{< ref "/posts/20260223_particle_filter/1.en.md" >}}) - Monte Carlo-based filtering for non-Gaussian distributions.
- [Kalman Smoother (RTS Smoother): Theory and Python Implementation]({{< ref "/posts/20260223_rts_smoother/1.en.md" >}}) - Smooths Kalman Filter results using observations from all time steps.
- [Time-Series Anomaly Detection: From Statistical Methods to Kalman Filter in Python]({{< ref "/posts/20260228_timeseries_anomaly/1.en.md" >}}) - Innovation-based anomaly detection using the Kalman filter.
