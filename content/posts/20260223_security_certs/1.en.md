...
draft: false
description: "CISSP vs Japan's Registered Information Security Specialist (RISS): a detailed comparison of exam domains, requirements, costs, difficulty level, and career impact for cybersecurity professionals."
...
- [OAuth 2.0 and OpenID Connect: Fundamentals of Authorization and Authentication]({{< ref "/posts/20260226_oauth2_oidc/1.en.md" >}}) - Covers authentication/authorization protocols included in exam scope.
- [Zero Trust Architecture: Principles, Components, and Implementation]({{< ref "/posts/20260226_zero_trust/1.en.md" >}}) - Covers Zero Trust architecture, a trending security topic.
- [RSA Encryption: Theory and Python Implementation]({{< ref "/posts/20260225_rsa/1.en.md" >}}) - Covers the cryptographic foundations included in exam scope.
