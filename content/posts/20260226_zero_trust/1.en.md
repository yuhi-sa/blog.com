...
draft: false
description: "What is Zero Trust? Architecture principles based on NIST SP 800-207, key components (identity, device, network), comparison with perimeter defense, and a phased implementation roadmap."
...
- [OAuth 2.0 and OpenID Connect: Fundamentals of Authorization and Authentication]({{< ref "/posts/20260226_oauth2_oidc/1.en.md" >}}) - The authentication protocol foundation for Zero Trust.
- [RSA Encryption: Theory and Python Implementation]({{< ref "/posts/20260225_rsa/1.en.md" >}}) - Cryptographic foundations used in Zero Trust.
- [Security Certification Comparison: CISSP vs Japan's Registered Information Security Specialist]({{< ref "/posts/20260223_security_certs/1.en.md" >}}) - Certification paths related to Zero Trust.
- [CISSP: Comparing Major Security Governance Frameworks]({{< ref "/posts/20240608_cissp/1.en.md" >}}) - Understand Zero Trust's position within the broader security framework landscape.
...
- [Email Security: Authentication and Encryption Technologies]({{< ref "/posts/20230328_mail_auth/1.en.md" >}}) - Email authentication as part of Zero Trust.
- [Micro Hardening Training Participation Report]({{< ref "/posts/20250821_hardening/1.en.md" >}}) - Hands-on security training experience.
