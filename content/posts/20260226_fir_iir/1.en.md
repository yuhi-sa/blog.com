...
draft: false
description: "FIR vs IIR filters compared: theory, stability, linear phase properties, frequency response analysis, and Python design examples using SciPy firwin and butter functions."
...
- [Moving Average Filters Compared: SMA, WMA, and EMA in Python]({{< ref "/posts/20260225_moving_average/1.en.md" >}}) - Compares types and characteristics of moving average filters, the most basic form of FIR filters.
- [Low-Pass Filter Design and Comparison]({{< ref "/posts/20260223_lowpass_filter/1.en.md" >}}) - Compares frequency responses of IIR filters including Butterworth and Chebyshev.
...
- [Notch Filter Design and Python Implementation]({{< ref "/posts/20260228_notch_filter/1.en.md" >}}) - IIR filter application for power line noise removal.
- [Adaptive Filters (LMS/RLS): Theory and Python Implementation]({{< ref "/posts/20260310_adaptive_filter/1.en.md" >}}) - An extension of FIR/IIR filters that automatically updates filter coefficients based on the input signal.
