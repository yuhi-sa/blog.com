...
draft: false
description: "Python decorators explained: how they work internally, parameterized decorators, class decorators, functools.wraps, and practical patterns for logging, caching, and retry logic."
...
- [Introduction to Asynchronous Programming with Python asyncio]({{< ref "/posts/20260226_python_asyncio/1.en.md" >}}) - Combining async with decorator patterns.
- [Python Regular Expressions: Practical Guide]({{< ref "/posts/20260226_python_regex/1.en.md" >}}) - Combining decorators with regex for validation patterns.
- [Building a Progress Bar in Python from Scratch]({{< ref "/posts/20260223_progress_bar/1.en.md" >}}) - Progress bar implementation using decorator patterns.
- [Matplotlib Practical Tips: Creating Publication-Quality Figures]({{< ref "/posts/20260223_matplotlib_tips/1.en.md" >}}) - Visualization best practices.
...
- [Setting Up a Python Development Environment]({{< ref "/posts/20210416_Py_Env/1.en.md" >}}) - Setting up Python development environments.

## References

- [Python official documentation: functools](https://docs.python.org/3/library/functools.html)
- Ramalho, L. (2022). [_Fluent Python_ (2nd ed.)](https://www.amazon.co.jp/dp/1492056359?tag=tomatomato119-22). O'Reilly Media. Chapter 9: Decorators and Closures.
