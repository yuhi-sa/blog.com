...
- [繰り返し二乗法による高速べき乗剰余計算のPython実装]({{< ref "/posts/20201220_Binary/1.md" >}}) - DH鍵交換の $g^a \bmod p$ 計算を高速化する繰り返し二乗法を解説しています。
- [楕円曲線ElGamal暗号の原理とPythonによる簡易実装]({{< ref "/posts/20201223_ElGamal/1.md" >}}) - DHと同じ離散対数問題を楕円曲線上に拡張したElGamal暗号を解説しています。
