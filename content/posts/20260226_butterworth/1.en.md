...
draft: false
description: "What is a Butterworth filter? Learn maximally flat magnitude response theory, analog-to-digital conversion (bilinear transform), and practical lowpass/highpass/bandpass design with Python SciPy."
...
- [Low-Pass Filter Design and Comparison]({{< ref "/posts/20260223_lowpass_filter/1.en.md" >}}) - Comparison of various lowpass filters including Butterworth.
- [FIR vs IIR Filters: Characteristics, Design, and Python Implementation]({{< ref "/posts/20260226_fir_iir/1.en.md" >}}) - Compares Butterworth (IIR) and FIR filter characteristics.
- [Wiener Filter: Optimal Linear Filtering Theory and Python Implementation]({{< ref "/posts/20260226_wiener_filter/1.en.md" >}}) - Contrasts Wiener's automatic band design with Butterworth's manual cutoff.
- [Notch Filter Design and Python Implementation]({{< ref "/posts/20260228_notch_filter/1.en.md" >}}) - IIR filter application for specific frequency removal.
...
- [Moving Average Filters Compared: SMA, WMA, and EMA in Python]({{< ref "/posts/20260225_moving_average/1.en.md" >}}) - Moving average filters as representative FIR filters.
- [Fundamentals of Filtering Methods in Signal Processing]({{< ref "/posts/20200901_Filter/1.en.md" >}}) - Systematic overview of various filters.
- [Savitzky-Golay Filter: Theory and Python Implementation]({{< ref "/posts/20260310_savitzky_golay/1.en.md" >}}) - An FIR polynomial fitting filter, contrasting with Butterworth's IIR approach to smoothing.
- [Adaptive Filters (LMS/RLS): Theory and Python Implementation]({{< ref "/posts/20260310_adaptive_filter/1.en.md" >}}) - Unlike Butterworth's fixed design, adaptive filters automatically adjust parameters based on the input signal.
