...
draft: false
description: "Python regex guide: re module basics, named groups, lookahead/lookbehind assertions, common patterns for log parsing and validation, and performance optimization tips with compiled patterns."
tags: ["Python"]
keywords:
  [
    "Python regex",
...
- [Python Decorators: Mechanics and Practical Patterns]({{< ref "/posts/20260226_python_decorators/1.en.md" >}}) - Combining decorators with regex for validation patterns.
- [Introduction to Asynchronous Programming with Python asyncio]({{< ref "/posts/20260226_python_asyncio/1.en.md" >}}) - Using regex in async text processing.
...
- Friedl, J. E. F. (2006). [_Mastering Regular Expressions_ (3rd ed.)](https://www.amazon.co.jp/dp/0596528124?tag=tomatomato119-22). O'Reilly Media.
