...
draft: false
description: "k-means vs GMM clustering: convergence theory, EM algorithm for Gaussian Mixture Models, scikit-learn implementation, and how to choose the number of clusters (elbow, silhouette, BIC)."
...
- [Ensemble Learning: From Decision Trees to Random Forest and Gradient Boosting]({{< ref "/posts/20260226_ensemble_learning/1.en.md" >}}) - Supervised learning methods; clustering results can serve as features.
- [Understanding Self-Attention from Scratch: Math and Python Implementation]({{< ref "/posts/20260228_self_attention/1.en.md" >}}) - Similarity between Attention's weighted averaging and GMM's mixture model.
- [Support Vector Machines (SVM): Kernel Methods and Nonlinear Classification with Python]({{< ref "/posts/20260226_svm/1.en.md" >}}) - Comparison with supervised classification; SVM finds boundaries while clustering discovers data structure.
- [Markov Chain Monte Carlo (MCMC): Metropolis-Hastings and Gibbs Sampling]({{< ref "/posts/20260226_mcmc/1.en.md" >}}) - MCMC can also estimate GMM parameters.
- [Bayesian Linear Regression: From Least Squares to Bayesian Estimation]({{< ref "/posts/20210108_bayes/1.en.md" >}}) - Bayesian foundations underlying GMM.
- [From SGD to Adam: Evolution of Gradient-Based Optimization]({{< ref "/posts/20260226_sgd_adam/1.en.md" >}}) - Understanding the relationship between EM and gradient methods.

## References

- Bishop, C. M. (2006). [_Pattern Recognition and Machine Learning_](https://www.amazon.co.jp/dp/0387310738?tag=tomatomato119-22). Springer. Chapters 9.
