...
draft: false
description: "k-means法とGMM（混合ガウスモデル）の違いとは？アルゴリズムの数理からEMアルゴリズム、scikit-learnでのPython実装、エルボー法・シルエット分析によるクラスタ数の決め方まで解説します。"
...
- [アンサンブル学習の手法と比較]({{< ref "/posts/20260226_ensemble_learning/1.md" >}}) - 教師あり学習の代表的手法。クラスタリング結果を特徴量として活用できます。
- [Self-Attentionの仕組みとPython実装]({{< ref "/posts/20260228_self_attention/1.md" >}}) - Attentionの重み付け平均とGMMの混合モデルの類似性を理解できます。
