...
draft: false
description: "MCMC explained: Metropolis-Hastings and Gibbs sampling algorithms with convergence diagnostics, and Python implementations for Bayesian posterior inference with visualization."
...
- [Simulated Annealing: Theory and Python Implementation]({{< ref "/posts/20260226_simulated_annealing/1.en.md" >}}) - Applies the same Metropolis criterion to optimization.
...
- [Particle Filter Python Implementation: Comparing Resampling Methods]({{< ref "/posts/20260223_particle_filter/1.en.md" >}}) - Sequential Monte Carlo (SMC), closely related to MCMC.
- [Bayesian Linear Regression: From Least Squares to Bayesian Estimation]({{< ref "/posts/20210108_bayes/1.en.md" >}}) - Analytical Bayesian inference without MCMC.
