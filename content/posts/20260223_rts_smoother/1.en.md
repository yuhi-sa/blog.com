...
draft: false
description: "What is the RTS smoother? Rauch-Tung-Striebel Kalman smoother theory explained with mathematical derivation, Python implementation, and accuracy comparison against the standard Kalman filter."
...
- [Kalman Filter: Theory and Python Implementation]({{< ref "/posts/20260224_kalman_filter/1.en.md" >}}) - The foundational Kalman filter that the RTS smoother extends.
- [Extended Kalman Filter (EKF): Theory and Python Implementation]({{< ref "/posts/20260224_ekf/1.en.md" >}}) - EKF for nonlinear models, which also serves as a basis for nonlinear smoothers.
- [Unscented Kalman Filter (UKF): Nonlinear State Estimation Theory and Python Implementation]({{< ref "/posts/20260226_ukf/1.en.md" >}}) - UKF, the foundation for UKF-based smoothers.
- [Particle Filter Python Implementation: Comparing Resampling Methods]({{< ref "/posts/20260223_particle_filter/1.en.md" >}}) - The particle filter that serves as the basis for particle smoothers.
- [Time-Series Anomaly Detection: From Statistical Methods to Kalman Filter in Python]({{< ref "/posts/20260228_timeseries_anomaly/1.en.md" >}}) - RTS smoother is useful as a preprocessing step for offline anomaly detection.
