...
draft: false
description: "How to remove 50/60 Hz power line noise: notch (band-reject) filter design with IIR theory, pole-zero analysis, quality factor tuning, and Python implementation using scipy.signal.iirnotch."
