...
### 参考
- [非同期処理 (1): Javascript の動作の流れ (JS エンジン / Call Stack / Event Queue)|Zenn](https://zenn.dev/redpanda/articles/ef719c7e592327)
...
- [イベントループと TypeScript の型から理解する非同期処理|Zenn](https://zenn.dev/mizchi/articles/understanding-promise-by-ts-eventloop)
