...
draft: false
description: "Wiener filter explained: optimal linear filter derivation via MSE minimization and Wiener-Hopf equation, with Python frequency-domain implementation for signal and image denoising."
...
- [Butterworth Filter Design: Theory and Python Implementation]({{< ref "/posts/20260226_butterworth/1.en.md" >}}) - Manual cutoff frequency vs Wiener's automatic band design.
- [FIR vs IIR Filters: Characteristics, Design, and Python Implementation]({{< ref "/posts/20260226_fir_iir/1.en.md" >}}) - Understand the design philosophy difference between classical filters and Wiener filter.
- [Fast Fourier Transform (FFT): Theory and Python Implementation]({{< ref "/posts/20260225_fft/1.en.md" >}}) - FFT is essential for implementing the Wiener filter.
- [Kalman Filter: Theory and Python Implementation]({{< ref "/posts/20260224_kalman_filter/1.en.md" >}}) - The Kalman filter as a non-stationary, sequential extension of the Wiener filter.
- [Time-Series Anomaly Detection: From Statistical Methods to Kalman Filter in Python]({{< ref "/posts/20260228_timeseries_anomaly/1.en.md" >}}) - Anomaly detection methods as an application of the Wiener filter.
...
- [Moving Average Filters Compared: SMA, WMA, and EMA in Python]({{< ref "/posts/20260225_moving_average/1.en.md" >}}) - Understand the design philosophy difference between moving average and Wiener filter.
- [Adaptive Filters (LMS/RLS): Theory and Python Implementation]({{< ref "/posts/20260310_adaptive_filter/1.en.md" >}}) - The LMS algorithm iteratively approximates the Wiener filter's optimal solution, and RLS converges even faster.
