...
- [Training Neural Networks with Genetic Algorithms in Python]({{< ref "/posts/20210109_nnga/1.en.md" >}}) - Optimizing NN weights using evolutionary methods instead of gradient descent
- [From SGD to Adam: Evolution of Gradient-Based Optimization]({{< ref "/posts/20260226_sgd_adam/1.en.md" >}}) - Advanced optimizers beyond the SGD used in this article
- [Understanding Self-Attention in Python: From Math to Scratch Implementation]({{< ref "/posts/20260228_self_attention/1.en.md" >}}) - Implementing the core mechanism of Transformers, an evolution of neural networks
