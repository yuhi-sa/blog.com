...
draft: false
description: "PyTorchでニューラルネットワークの教師あり学習を実装。nn.Moduleを継承したモデル定義から誤差逆伝播による学習までを解説します。"
tags: ["機械学習"]
keywords: ["機械学習"]
---
...
- [遺伝的アルゴリズムによるニューラルネットワーク学習のPython実装]({{< ref "/posts/20210109_nnga/1.md" >}}) - 勾配法ではなく進化的手法でNNの重みを最適化するアプローチ
- [確率的勾配降下法からAdamまで：勾配ベース最適化の進化]({{< ref "/posts/20260226_sgd_adam/1.md" >}}) - 本記事で使用したSGDの発展形であるAdam等の最適化手法を解説
- [Pythonで理解するSelf-Attentionの仕組み：数式からスクラッチ実装まで]({{< ref "/posts/20260228_self_attention/1.md" >}}) - NNの発展形であるTransformerの中核機構を実装
