...
- [Commitizenによる統一されたGitコミットメッセージの管理]({{< ref "/posts/20231208_CZ/1.md" >}}) - コミットメッセージの統一ルールを自動化するツールの導入方法
- [Gitブランチ戦略：rebase vs merge の使い分けとチーム運用]({{< ref "/posts/20260226_git_branch_strategy/1.md" >}}) - チーム開発におけるブランチ管理のベストプラクティス
