...
- [Managing Unified Git Commit Messages with Commitizen]({{< ref "/posts/20231208_CZ/1.en.md" >}}) - How to automate and standardize commit message conventions
- [Git Branch Strategies: rebase vs merge and Team Workflows]({{< ref "/posts/20260226_git_branch_strategy/1.en.md" >}}) - Best practices for branch management in team development
